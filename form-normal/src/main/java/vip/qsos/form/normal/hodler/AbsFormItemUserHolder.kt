...
abstract class AbsFormItemUserHolder(
        itemView: View
) : AbsFormHolder<FormItemEntity<FormValueOfUser>, FormValueOfUser>(itemView) {

    /**点击用户选择后方法调用*/
    abstract fun selectUser(data: FormItemEntity<FormValueOfUser>, listener: OnTListener<Boolean>)
